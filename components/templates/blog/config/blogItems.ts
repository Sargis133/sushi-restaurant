...
export const blogItems: I_BlogItems[] = [
    ...
    {
        image: 'images/pages/blog-4.png',
        date: '24TH AUG 2023',
        title: 'Palate with Qitchen\'s Unsurpassed Sushi Delicacies',
        text: 'Discover the heights of gastronomic delight as Qitchen\'s sushi transports you to a new culinary realm.'
    },
    {
        image: 'images/pages/blog-5.png',
        date: '24TH AUG 2023',
